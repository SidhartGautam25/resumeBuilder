...
export default function Formtwo({exp,setexp,secdiv,setsecdiv,ind,addexp}) {
    // console.log("here ");
    // console.log(data)
   ...
   return(
    ...
    <div className={styles.inputcont}>
        <div className={styles.labelcont}><label className={styles.labelsclass}>Role</label></div>
    ...
    <div className={styles.inputcont}>
        <div className={styles.labelcont}><label className={styles.labelsclass}>Company</label></div>
        <input className={styles.inputarea}
            type="text"
            name="compname"
